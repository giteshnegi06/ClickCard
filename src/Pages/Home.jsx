...
const Home = () => {
  ...
  const [activeItem, setActiveItem] = React.useState(location.profile)
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 items-start ">
        ...
        <div className="lg:col-span-7 space-y-3.5">
          ...
          <div className="bg-zinc-100 p-5 rounded-[40px] border border-zinc-200/80 shadow-[inset_0_1.5px_4px_rgba(0,0,0,0.02)] flex justify-center items-center relative overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-81.25 h-150 overflow-y-auto  rounded-[26px] shadow-xl border-8 border-zinc-800">
        ...
        <div className="lg:col-span-5 space-y-3.5 h-full">
          ...
          <div className="bg-white border border-zinc-200 rounded-3xl p-6 shadow-[0_1px_3px_rgba(0,0,0,0.01)] text-center flex flex-col justify-between h-full min-h-115 space-y-6">
            ...
            {/* QR image block */}
            <div className="p-4 bg-zinc-50 border border-zinc-150 rounded-2xl max-w-xs w-full mx-auto aspect-square flex items-center justify-center shadow-inner relative group">
              <img
                src="https://res.cloudinary.com/dh52la71p/image/upload/v1780815605/qrcode_359526586_7089f23c8f55c522c0dd902753f4f542_yggx4e.png"
